...
|RF-008| A aplicação deve permitir que o gerente de quadra consiga adicionar quadras. | Alta |
|RF-009| A aplicação deve permitir que o gerente de quadra ative e desative as quadras. | Alta |
...
Quadro Kanban: 
![Quadro Kanban - Versão final](img/quadro_kanban_socialtennis.png.png)
